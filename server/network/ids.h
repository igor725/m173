...
constexpr PacketId PlayerHealth   = 0x08;
constexpr PacketId PlayerRespawn  = 0x09;
constexpr PacketId PlayerFall     = 0x0a;
...
constexpr PacketId EntityRelMove  = 0x1f;
...
constexpr PacketId ConnectionFin  = 0xff;
} // namespace Packet::IDs
